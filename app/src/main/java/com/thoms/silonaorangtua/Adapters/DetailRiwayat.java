...
public class DetailRiwayat extends RecyclerView.Adapter<DetailRiwayat.ConnectedAdapterViewHolder> {
    ArrayList<AnakDaftar> nameList;
    Context c;

    public DetailRiwayat(ArrayList<AnakDaftar> nameList,Context c)
    {
    ...
    @Override
    public DetailRiwayat.ConnectedAdapterViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.detail_isi_riwayat,parent,false);
        DetailRiwayat.ConnectedAdapterViewHolder viewHolder1 = new DetailRiwayat.ConnectedAdapterViewHolder(view,c,nameList);
        return viewHolder1;
    }
    ...
    @Override
    public void onBindViewHolder(DetailRiwayat.ConnectedAdapterViewHolder holder, int position) {
            ...
            implements View.OnCreateContextMenuListener, MenuItem.OnMenuItemClickListener,View.OnClickListener
    {
        ...
        public ConnectedAdapterViewHolder(View itemView,Context ctx,ArrayList<AnakDaftar> nameArrayList) {
            ...
            name_txt = (TextView)itemView.findViewById(R.id.nama_title);
